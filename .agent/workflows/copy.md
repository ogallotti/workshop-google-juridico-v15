...
Ao finalizar, salve a copy estruturada em um arquivo `copy.md` na raiz do projeto. Este arquivo será usado pelo workflow `/design` e `/layout`.
...
- Após entregar a copy e sugerir o próximo passo, AGUARDE instrução do usuário
- Se o usuário não der instrução, NÃO faça nada
- Se o usuário pedir ajustes na copy, faça os ajustes e PARE novamente
