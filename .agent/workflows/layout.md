...
A implementação será feita APENAS quando o usuário usar `/build`.
...
5. Sugira a próxima etapa: "Quando a especificação estiver aprovada, use `/build` para construir a página completa."
...
- Após entregar a especificação e sugerir o próximo passo, AGUARDE instrução do usuário
- Se o usuário não der instrução, NÃO faça nada
- Se o usuário pedir ajustes na especificação, faça os ajustes e PARE novamente
